...
final class NodeTypeSchemaGenerator
{
    ...
    private function packageSchema(
        ...
        // elementFormDefault is left unset, which means unqualified: properties are unqualified
        // local elements and node types are qualified globals, and that is the whole distinction the
        // format rests on. Setting it to "unqualified" states the XSD default and an IDE reports it
        // as redundant; setting it to "qualified" would break the format.
