...
/**
 * One node in a seed file, as written — not yet checked against a node type.
 *
 ...
 * names a tethered node explicitly (seed:name), which is needed where a node type has more than one
